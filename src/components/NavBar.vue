...
import CartLogo from '@/components/icons/CartLogo.vue'
import CategoryLogo from '@/components/icons/CategoryLogo.vue'
import CraftedByLogo from '@/assets/CraftedByLogo.vue'
...
<template>
  <nav class="bg-white border-b-2  dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-2" id="navbar-search">
        ...
        <ul
          ...
          <li>
            <RouterLink to="/TestFetch"
               class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
              <CategoryLogo />
            </RouterLink>
          </li>
          <li>
            <div class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
              <RouterLink
                v-if="!isConnected" to="">
                <ConnectionModal />
              </RouterLink>
              <RouterLink v-else to="/logout">
                <ProfileAvatar />
              </RouterLink>
            </div>
          </li>
